...
namespace SqlToGraphite.UnitTests
{
    ...
    public class ManualTests
    {
        ...
        public void Should_try_controller()
        {
            ...
            var tasks = new List<IRunTask> { new RunableRunTask(new SqlServer(), new DataClientFactory(log), new GraphiteClientFactory(log), new GraphiteParams("hostname", 1234), log, new ConfigSpike.GraphiteTcpClient()) };
