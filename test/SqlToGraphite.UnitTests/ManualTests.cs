...
namespace SqlToGraphite.UnitTests
{
    ...
    public class ManualTests
    {
        ...
        public void Should_try_controller()
        {
            ...
            var tasks = new List<IRunTask> { new RunableRunTask(new SqlServerClient(), new DataClientFactory(log, null), new GraphiteClientFactory(log), log, new GraphiteTcpClient()) };
