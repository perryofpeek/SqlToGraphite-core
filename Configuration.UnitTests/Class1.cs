...
namespace Configuration.UnitTests
{
    ...
    public class Class1
    {
        ...
        public void Should_display_all_clients()
        {
            ...
            var clients = new List<SqlToGraphiteConfigClientsClient>();
            var rtn1 = new SqlToGraphiteConfigClientsClient { name = "nameA", port = "32" };
            var rtn2 = new SqlToGraphiteConfigClientsClient { name = "nameB", port = "33" };
            clients.Add(rtn1);
            clients.Add(rtn2);
